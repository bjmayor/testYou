      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="jump_question.html"><i class="fa fa-circle-o text-yellow"></i>多选跳转</a></li>
                  ...
                  <div class="col-sm-10">
                    <div class="row">
                      ...
                      <div class="col-xs-3 col-sm-3">
                        <input type="text" class="form-control" placeholder="跳转的问题编号或结果">
                      </div>
